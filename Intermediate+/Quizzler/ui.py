...
class QuizInterface():
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.yes = tkinter.PhotoImage(file = "images/true.png")
        self.no = tkinter.PhotoImage(file = "images/false.png")

        self.yes_button= tkinter.Button(image = self.yes, highlightthickness= 0, command = self.true_pressed)
        self.yes_button.grid(row = 2, column = 0)
        self.no_button = tkinter.Button(image=self.no, highlightthickness=0, command = self.false_pressed)
